    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                assert self.ant.is_container == True or insect.is_container == True, 'Two ants in {0}'.format(self)
                if self.ant.is_container:
                    assert self.ant.contained_ant is None and insect.is_container == False, 'Two ants in {0}'.format(self)
...
class Insect(object):
    ...
    is_ant = False
    damage = 0
    is_watersafe = False  # ADD CLASS ATTRIBUTES HERE
...
class Bee(Insect):
    ...
    name = 'Bee'
    damage = 1
    is_watersafe = True  # OVERRIDE CLASS ATTRIBUTES HERE
    ...
    def action(self, colony):
        ...
        # BEGIN EC
        to_hive = self.place.entrance
        if self.moving_forward == False and to_hive != Hive:
            self.move_to(to_hive)
            return None
        # END EC
        if self.blocked():
...
class Ant(Insect):
    ...
    food_cost = 0
    blocks_path = True
    is_container = False  # ADD CLASS ATTRIBUTES HERE
...
class ThrowerAnt(Ant):
    ...
    food_cost = 3
    min_range = 0
    max_range = float('inf')  # ADD/OVERRIDE CLASS ATTRIBUTES HERE
    ...
    def nearest_bee(self, hive):
        ...
        current_place, i = self.place, 0
        while current_place.entrance != hive:
...
class FireAnt(Ant):
    ...
    name = 'Fire'
    damage = 3
    food_cost = 5  # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN Problem 5
    implemented = True   # Change to True to view in the GUI
    # END Problem 5
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
            fire_ant_damage = self.damage
            for bee in bee_list:
                Insect.reduce_armor(bee, fire_ant_damage)
        # END Problem 5
...
class HungryAnt(Ant):
    ...
    name = 'Hungry'
    food_cost = 4
    time_to_digest = 3  # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN Problem 6
    implemented = True   # Change to True to view in the GUI
    # END Problem 6
    ...
    def action(self, colony):
        ...
        if self.digesting:
            ...
            bee_on_site = list(self.place.bees)
            bee_for_eat = random_or_none(bee_on_site)
            if bee_for_eat:
                HungryAnt.eat_bee(self, bee_for_eat)
        # END Problem 6
...
class NinjaAnt(Ant):
    ...
    damage = 1
    food_cost = 5
    blocks_path = False  # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN Problem 7
    implemented = True   # Change to True to view in the GUI
    # END Problem 7
    ...
    def action(self, colony):
        # BEGIN Problem 7
        bee_fly_pass = list(self.place.bees)
        ninja_damage = self.damage
        for bee in bee_fly_pass:
            Insect.reduce_armor(bee, ninja_damage)
        # END Problem 7

# BEGIN Problem 8
class WallAnt(Ant): # The WallAnt class
    """WallAnt has high value of armor so that it can hold back bees for longer time."""
...
class BodyguardAnt(Ant):
    ...
    def action(self, colony):
        # BEGIN Problem 9
        contain_ant = self.contained_ant
        if self.armor:
            self.armor -= 1
        else:
            self.place.remove_ant(self)
        if contain_ant:
            contain_ant.action(colony)
        # END Problem 9
...
class TankAnt(BodyguardAnt):
    ...
    def action(self, colony):
        # BEGIN Problem 10
        tank_damage = self.damage
        bee_list = list(self.place.bees)
        BodyguardAnt.action(self, colony)
        if bee_list:
            for bee in bee_list:
                Insect.reduce_armor(bee, tank_damage)
        # END Problem 10
...
class ScubaThrower(ThrowerAnt):  # The ScubaThrower class
    """ScubaThrower is wwatersafe and more costly but otherwise the same as ThrowerAnt"""
...
# END Problem 13
    ...
    food_cost = 7
    queen_list = []
    queen_buff_list = []  # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN Problem 13
    implemented = True   # Change to True to view in the GUI
    # END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        if QueenAnt.queen_list == []:
            self.is_truequeen = True
        else:
            self.is_truequeen = False
        QueenAnt.queen_list.append(self)
        # END Problem 13
    ...
    def action(self, colony):
        ...
        if self.is_truequeen == True:
            ...
            while current_place:
                if current_place.ant and current_place.ant not in QueenAnt.queen_buff_list:
                    current_place.ant.damage *= 2
                    QueenAnt.queen_buff_list.append(current_place.ant)
                if current_place.ant and current_place.ant.is_container:
                    if current_place.ant.contained_ant and current_place.ant.contained_ant not in QueenAnt.queen_buff_list:
                        current_place.ant.contained_ant.damage *= 2
                        QueenAnt.queen_buff_list.append(current_place.ant.contained_ant)
    ...
    def reduce_armor(self, amount):
        ...
        if self.is_truequeen == True and self.armor <= 0:
            bees_win()
        # END Problem 13
...
def make_scare(action, bee):
    ...
    def scared_action(colony):
        if bee.moving_forward == True:
            bee.moving_forward = False
        return action(colony)
...
def apply_effect(effect, bee, duration):
    ...
    present_action = effect(bee.action, bee)
    def modified_action(colony):
        nonlocal duration
        if duration > 0:
            present_action(colony)
        else:
            if effect == make_scare:
                bee.moving_forward = True
