...
(even? (sqrt (+ (log10 1000) (sin (radians 90)) (modulo -10 3) (* 2 5))))
; expect #t

(define hello (sqrt (* (+ 2 7) (log10 10000))))
; expect hello
...
(begin (define x 3) (print 4) (lambda (y) 3))
; expect (lambda (y) 3)

(begin (* 6 8) (- 2 5) (define hello (+ 4 7)))
; expect hello

(lambda (x y z) (* x (/ y z)))
; expect (lambda (x y z) (* x (/ y z)))

(define (hi x y z) (lambda (x y) (+ x y)))
; expect hi
...
(and 1  nil #t (or #f (/ 6 2)))
; expect 3

(cond
  ((even? 3) (* 4 5))
  ((> 3 2) (- 8 3) (/ 6 2) 'hello (< 3 2))
  (else (/ 3 0)))
;expect #f
...
(define larger (mu () (if (> a b) a b)))
; expect larger

(define (insert a b) (larger))
; expect insert
