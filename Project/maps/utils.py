...
def key_of_min_value(d):
    ...
    """
    # BEGIN Question 0
    return min(d, key = lambda x: d[x]) # Return the key in the dictionary with minimum value.
    # END Question 0
...
def enumerate(s, start=0):
    ...
    """
    # BEGIN Question 0
    return zip(range(start, start + len(list(s))), list(s))
    # END Question 0
