...
def make_restaurant(name, location, categories, price, reviews):
    ...
    # BEGIN Question 2
    return [name, location, categories, price, reviews] # Constructor
    # END Question 2

def restaurant_name(restaurant):
    """Return the name of the restaurant, which is a string."""
    # BEGIN Question 2
    return restaurant[0] # Selector: restaurant name
    # END Question 2
...
def restaurant_ratings(restaurant):
    ...
    # BEGIN Question 2
    return [review_rating(r) for r in restaurant[4]] # Selector: restaurant rating
    # END Question 2
